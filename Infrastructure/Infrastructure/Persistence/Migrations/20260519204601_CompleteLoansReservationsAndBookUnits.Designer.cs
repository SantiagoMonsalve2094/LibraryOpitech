...
namespace LibraryOpitech.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260519204601_CompleteLoansReservationsAndBookUnits")]
    partial class CompleteLoansReservationsAndBookUnits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryOpitech.Domain.Entities.BookUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BookUnits", (string)null);
                });
            ...
            modelBuilder.Entity("LibraryOpitech.Domain.Entities.Loan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BookUnitId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryOpitech.Domain.Entities.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryOpitech.Domain.Entities.Loan", b =>
                {
                    b.HasOne("LibraryOpitech.Domain.Entities.BookUnit", "BookUnit")
                        .WithMany("Loans")
                        .HasForeignKey("BookUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LibraryOpitech.Domain.Entities.User", "User")
                        .WithMany("Loans")
